import numpy as np
from Utils.load_data import load_rf1
from Methods.VectorialModel import VectorialModel, mrrmse
...
print('Results obtained without Sketching on rf1 dataset: ')
...
for i in range(3):
    ...
    if i == 0:
        print('Results obtained with 20/n-SR sketch on rf1 dataset: ')
    elif i == 1:
        print('Results obtained with 20/n-SG sketch on rf1 dataset: ')
    else:
        print('Results obtained with Accumulation (m=20) on rf1 dataset: ')
