import numpy as np
from Utils.load_data import load_scm1d
...
# Loading dataset
X_tr, Y_tr, X_te, Y_te = load_scm1d()
n_tr = X_tr.shape[0]
n_te = X_te.shape[0]
d = Y_tr.shape[1]
...
print('Results obtained without Sketching on scm1d dataset: ')
...
print('mtlp2: ' + str(rrmse_test_wo_S[0, 1]))
print('mtlp3: ' + str(rrmse_test_wo_S[0, 2]))
print('mtlp4: ' + str(rrmse_test_wo_S[0, 3]))
print('mtlp5: ' + str(rrmse_test_wo_S[0, 4]))
print('mtlp6: ' + str(rrmse_test_wo_S[0, 5]))
print('mtlp7: ' + str(rrmse_test_wo_S[0, 6]))
print('mtlp8: ' + str(rrmse_test_wo_S[0, 7]))
print('mtlp9: ' + str(rrmse_test_wo_S[0, 8]))
print('mtlp10: ' + str(rrmse_test_wo_S[0, 9]))
print('mtlp11: ' + str(rrmse_test_wo_S[0, 10]))
print('mtlp12: ' + str(rrmse_test_wo_S[0, 11]))
print('mtlp13: ' + str(rrmse_test_wo_S[0, 12]))
print('mtlp14: ' + str(rrmse_test_wo_S[0, 13]))
print('mtlp15: ' + str(rrmse_test_wo_S[0, 14]))
print('mtlp16: ' + str(rrmse_test_wo_S[0, 15]))
...
for i in range(3):
    ...
    if i == 0:
        print('Results obtained with 20/n-SR sketch on scm1d dataset: ')
    elif i == 1:
        print('Results obtained with 20/n-SG sketch on scm1d dataset: ')
    else:
        print('Results obtained with Accumulation (m=20) on scm1d dataset: ')
    ...
    print('mtlp2: ' + str(rrmse_test_mean[1]) + ' +- ' + str(rrmse_test_std[1]))
    print('mtlp3: ' + str(rrmse_test_mean[2]) + ' +- ' + str(rrmse_test_std[2]))
    print('mtlp4: ' + str(rrmse_test_mean[3]) + ' +- ' + str(rrmse_test_std[3]))
    print('mtlp5: ' + str(rrmse_test_mean[4]) + ' +- ' + str(rrmse_test_std[4]))
    print('mtlp6: ' + str(rrmse_test_mean[5]) + ' +- ' + str(rrmse_test_std[5]))
    print('mtlp7: ' + str(rrmse_test_mean[6]) + ' +- ' + str(rrmse_test_std[6]))
    print('mtlp8: ' + str(rrmse_test_mean[7]) + ' +- ' + str(rrmse_test_std[7]))
    print('mtlp9: ' + str(rrmse_test_mean[8]) + ' +- ' + str(rrmse_test_std[8]))
    print('mtlp10: ' + str(rrmse_test_mean[9]) + ' +- ' + str(rrmse_test_std[9]))
    print('mtlp11: ' + str(rrmse_test_mean[10]) + ' +- ' + str(rrmse_test_std[10]))
    print('mtlp12: ' + str(rrmse_test_mean[11]) + ' +- ' + str(rrmse_test_std[11]))
    print('mtlp13: ' + str(rrmse_test_mean[12]) + ' +- ' + str(rrmse_test_std[12]))
    print('mtlp14: ' + str(rrmse_test_mean[13]) + ' +- ' + str(rrmse_test_std[13]))
    print('mtlp15: ' + str(rrmse_test_mean[14]) + ' +- ' + str(rrmse_test_std[14]))
    print('mtlp16: ' + str(rrmse_test_mean[15]) + ' +- ' + str(rrmse_test_std[15]))
